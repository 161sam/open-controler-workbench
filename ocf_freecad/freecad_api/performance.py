...
from ocf_freecad.freecad_api.metadata import get_document_data, set_document_data

PERFORMANCE_FLAG_KEY = "OCFDebugProfiling"
PERFORMANCE_DATA_KEY = "OCFPerformance"

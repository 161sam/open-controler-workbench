...
from ocf_freecad.gui.overlay.conflict_lines import conflict_items
from ocf_freecad.gui.overlay.distance_markers import measurement_items
from ocf_freecad.gui.overlay.labels import constraint_detail_label
from ocf_freecad.gui.overlay.measurements import (
    bbox_from_shape,
    expanded_shape,
    midpoint,
...
def _legend(settings: dict[str, Any], validation: dict[str, Any]) -> list[dict[str, Any]]:
    from ocf_freecad.gui.overlay.legend import build_legend_items

...
OVERLAY_COLORS = {
    ...
    "component_hover": {"rgb": (0.58, 0.84, 0.98), "line_rgb": (0.16, 0.49, 0.76), "transparency": 50, "line_width": 4},
    "component_hover_warning": {"rgb": (0.98, 0.83, 0.3), "line_rgb": (0.76, 0.53, 0.08), "transparency": 42, "line_width": 4},
    "component_hover_error": {"rgb": (0.97, 0.5, 0.42), "line_rgb": (0.72, 0.14, 0.14), "transparency": 34, "line_width": 5},
